        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row d-flex justify-content-between align-items-center" style="height: 100vh;">
                            ...
                            <form action="" id="login-form">
                                ...
                                <div class="card-body border-0">
                                    ...
                                    <div class="form-check mb-3">
                                        ...
                                        <a href="" class="text-decoration-none fs-6 fw-bold float-end">
                                            Forgot Password..?
                                        </a>
                                    </div>

                                    <div class="mb-2 d-flex justify-content-between align-items-center">
                                        <button class="btn btn-primary w-25 fw-bold">LOGIN</button>
                                        <span class="text-info-emphasis">Don't have any account..?
                                            <button class="btn btn-outline-dark ms-2">Register</button>
                                        </span>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-md-5 me-5 d-none">
                        <div class="card bg-white shadow rounded border-0">
                            ...
                            <form action="" id="login-form">
                                ...
                                <div class="card-body border-0">
                                    ...
                                    <div class="mb-2 d-flex justify-content-between align-items-center">
                                        <button class="btn btn-primary w-25 fw-bold">Signup</button>
                                        <span class="text-info-emphasis">Allready have an account..?
                                            <button class="btn btn-outline-dark ms-2">Sign In</button>
                                        </span>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card bg-white shadow rounded border-0 py-4">
                            ...
                            <form action="" id="login-form">
                                ...
                                <div class="card-body border-0">
                                    ...
                                    <div class="mb-2 d-flex justify-content-between align-items-center">
                                        <button class="btn btn-primary fw-bold">Send Passwqord Reset Link</button>
                                        <button class="btn btn-outline-dark ms-2">Back to Login</button>
                                    </div>
                                </div>
                            </form>
